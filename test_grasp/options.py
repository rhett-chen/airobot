...
def make_parser():
    ...
    parser.add_argument('--pose_file', type=str, default='grasp_pose_6dof1024obj_manual_seg.npy',
    ...
    parser.add_argument('--control_mode', choices={"linear", "direct"}, default='linear', type=str,
    ...
    parser.add_argument('--method', choices={"6dof-graspnet", "GPNet", "graspnet_baseline"},
                        default='6dof-graspnet', type=str,
                        help='grasp methods have been implemented: GPNet | 6dof-graspnet | graspnet_baseline')
    parser.add_argument('--vis_method', choices={'mayavi', 'open3d'}, default='open3d', type=str,
